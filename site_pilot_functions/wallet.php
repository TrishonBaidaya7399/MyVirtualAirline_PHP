...
.route-map-section {
    ...
    background-image: url('../assets/images/backgrounds/wallet.png');
...
#wallet_wrapper .row .col-sm-6 {
    padding-left: 0 !important;
    padding-right: 0 !important;
}

#wallet_wrapper .row .col-sm-5 {
    padding-left: 0 !important;
    padding-right: 0 !important;
...
#wallet_wrapper .row .col-sm-7 {
    background: transparent !important;
    padding: 0 !important;
}

#wallet_wrapper .row .col-sm-12 {
    overflow-x: auto;
}
                ...
                <div class="route-map-glass-card">
                    <div class="route-map-header">
                        <div class="route-map-title-wrapper">
                            <h3 class="route-map-title">Wallet</h3>
                            <i class="fa fa-wallet route-map-icon" aria-hidden="true"></i>
                        </div>
                        <hr />
                        <h1>Balance: $<span ><?php echo number_format($pilot->wallet, 2) ?></span></h1>
                    </div>
                </div>
            </div>
        </div>
        <div class="row" style="width: 100%">
            <div class="col-12">
                <div class="global-heading">
                    <h3 class="global-title"><i class="fa fa-exchange"></i> Transactions</h3>
                </div>
                <div class="flights-table-glass-card">
                    <div class="flights-table-wrapper">
                        <table class="table table-striped flights-table" id="wallet">
                            <thead>
                                <tr>
